...
var inherits = require('inherits'),
    ...
    SOAP    = require('../soap'),
	storeMetadata = require('../../../../server/controllers/login-Controller');
...
Metadata.prototype.retrieve = function(request, callback) {
  ...
  console.log('ret 449!!!!!!!!!!!!!!!!!!!!!!!!!'+JSON.stringify(res));
  ...
  resultStream._read = function() {
    ...
    self.complete(function(err, result) {
      if (err) {
    	...
    	console.log('In Metadata --SSSSSSSSSSSSSSSS'+result.zipFile);
        resultStream.push(new Buffer(result.zipFile, 'base64'));
        storeMetadata.StoreRetrieveMetadata(result.zipFile);
        resultStream.push(null);
        console.log('In Metadata -Return ***770'+JSON.stringify(resultStream));
        return resultStream;
      }
    });    
  };  
